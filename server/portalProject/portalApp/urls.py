...
urlpatterns = [
    ...
    path("seeker-register/register-seeker/", views.seekerRegistration, name="seeker-register"),
    path("company-register/register-company/", views.companyRegistration, name="company-register"),
